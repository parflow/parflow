...
/**
 *
 * This routines creates the overlayed variables for an invoice.  After
 * this call overlayed variables may be manipulated up to the use
 * of the invoice in a communication routine.
 *
 * {\large Example:}
 * \begin{verbatim}
 * \end{verbatim}
 ...
 * {\large Notes:}
 *
 * @memo Create overlayed variables associated with an invoice
 * @param comm Communication context [IN]
 * @param inv Invoice to create overlayed variables for [IN/OUT]
 * @return Error code
 */
