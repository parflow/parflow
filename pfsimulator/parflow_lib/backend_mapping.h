...
#if defined(MemPrefetchHostToDevice_cuda) || defined(MemPrefetchHostToDevice_omp)
...
#if defined(SKIP_PARALLEL_SYNC_cuda) || defined(SKIP_PARALLEL_SYNC_omp)
...
#if defined(PARALLEL_SYNC_cuda) || defined(PARALLEL_SYNC_omp)
...
#if defined(GrGeomPatchLoopBoxes_cuda) || defined(GrGeomPatchLoopBoxes_omp)
...
#if defined(GrGeomPatchLoopBoxesNoFdir_cuda) || defined(GrGeomPatchLoopBoxesNoFdir_omp)
...
#if defined(GrGeomOctreeExteriorNodeLoop_cuda) || defined(GrGeomOctreeExteriorNodeLoop_omp)
...
#if defined(GrGeomOutLoop_cuda) || defined(GrGeomOutLoop_omp)
