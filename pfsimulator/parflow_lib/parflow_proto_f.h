...
#define CALL_CLM_LSM(pressure_data, saturation_data, evap_trans_data, top, bottom, porosity_data, sres_data,                                                                                                                                                                                                 \
                     ...
                     clm_beta_function, clm_veg_function, clm_veg_wilting, clm_veg_fieldc, clm_res_sat, sm_stress_type, sm_residual_margin, sm_min_ramp_width, clm_per_pft_water_stress,                                                                                                                     \
        ...
        CLM_LSM(pressure_data, saturation_data, evap_trans_data, top, bottom, porosity_data, sres_data,                                                                                                                                                                                                      \
                ...
                &clm_res_sat, &sm_stress_type, &sm_residual_margin, &sm_min_ramp_width, &clm_per_pft_water_stress, &clm_irr_type, &clm_irr_cycle, &clm_irr_rate, &clm_irr_start, &clm_irr_stop,                                                                                                              \
                &clm_irr_threshold, qirr, qirr_inst, iflag, &clm_irr_thresholdtype, &soi_z, &clm_next, &clm_write_logs, &clm_last_rst, &clm_daily_rst, &clm_water_stress_type, &clm_nlevsoi, &clm_nlevlak,                                                                                                   \
                &clm_snow_partition, &clm_tw_threshold, &clm_thin_snow_damping, &clm_thin_snow_threshold,                                                                                                                                                                                                    \
                &clm_snow_tcrit, &clm_snow_t_low, &clm_snow_t_high, &clm_snow_transition_width,                                                                                                                                                                                                              \
                &clm_dai_a, &clm_dai_b, &clm_dai_c, &clm_dai_d, &clm_jennings_a, &clm_jennings_b, &clm_jennings_g,                                                                                                                                                                                           \
...
void CLM_LSM(double *pressure_data, double *saturation_data, double *evap_trans_data, double *top, double *bottom, double *porosity_data, double *sres_data,
             ...
             int *clm_veg_function, double *clm_veg_wilting, double *clm_veg_fieldc, double *clm_res_sat, int *sm_stress_type, double *sm_residual_margin, double *sm_min_ramp_width, int *clm_per_pft_water_stress,
