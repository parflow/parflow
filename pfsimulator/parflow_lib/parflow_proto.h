...
typedef PFModule * (*KinsolPCInitInstanceXtraInvoke) (Problem *problem, Grid *grid, Grid *grid2d, ProblemData *problem_data, double *temp_data, Vector *pressure, Vector *old_pressure, Vector *saturation, Vector *density, Vector *evap_trans, double dt, double time);
typedef PFModule *(*KinsolPCNewPublicXtraInvoke) (char *name, char *pc_name);

/* kinsol_pc.c */
void KinsolPC(Vector *rhs);
PFModule *KinsolPCInitInstanceXtra(Problem *problem, Grid *grid, Grid *grid2d, ProblemData *problem_data, double *temp_data, Vector *pressure, Vector *old_pressure, Vector *saturation, Vector *density, Vector *evap_trans, double dt, double time);
...
typedef void (*RichardsJacobianEvalInvoke) (Vector *pressure, Vector *old_pressure, Matrix **ptr_to_J, Matrix **ptr_to_JC, Vector *saturation, Vector *density, Vector *evap_trans, ProblemData *problem_data, double dt, double time, int symm_part);
...
#endif
void RichardsJacobianEval(Vector *pressure, Vector *old_pressure, Matrix **ptr_to_J, Matrix **ptr_to_JC, Vector *saturation, Vector *density, Vector *evap_trans, ProblemData *problem_data, double dt, double time, int symm_part);
