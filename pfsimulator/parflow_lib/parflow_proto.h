...
typedef int (*NonlinSolverInvoke) (N_Vector speciesNVector , N_Vector stateContainerNVector, double t , double dt , ProblemData *problem_data);
...
typedef PFModule * (*KinsolPCInitInstanceXtraInvoke) (Problem *problem , Grid *grid , ProblemData *problem_data , double *temp_data , N_Vector speciesNVector , void* current_state );
typedef PFModule *(*KinsolPCNewPublicXtraInvoke) (char *name , char *pc_name );

/* kinsol_pc.c */
void KinsolPC (Vector *rhs );
PFModule *KinsolPCInitInstanceXtra (Problem *problem , Grid *grid , ProblemData *problem_data , double *temp_data , N_Vector speciesNVector , void * current_state);
...
typedef void (*NlFunctionEvalInvoke) (N_Vector speciesNVector , Vector *fval , void *current_state);
...
void NlFunctionEval (N_Vector speciesNVector , Vector *fval , void* currect_state);
...
typedef void (*RichardsJacobianEvalInvoke) (N_Vector speciesNVector, void* current_state , Matrix **ptr_to_J , Matrix **ptr_to_JC, int symm_part );
...
void RichardsJacobianEval (N_Vector speciesNVector, void* current_state , Matrix **ptr_to_J , Matrix **ptr_to_JC, int symm_part );
