...
pfset Wells.inj_test.Cycle		    constant
...
pfset Wells.inj_test.alltime.Flux.water.Value 20.0
pfset Wells.inj_test.alltime.Concentration.water.tce1.Value   0.0
pfset Wells.inj_test.alltime.Concentration.water.tce2.Value   0.9
pfset Wells.inj_test.alltime.Saturation.water.Value   1.0
...
if { [info exists ::env(PF_TEST) ] } {
    ...
    if ![pftestFile $TEST.out.concen.0.00.00025.pfsb "Max difference in concen" $sig_digits] {
	set passed 0
    }

    if ![pftestFile $TEST.out.concen.0.01.00025.pfsb "Max difference in concen" $sig_digits] {
	set passed 0
    }
