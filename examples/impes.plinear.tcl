...
pfset Patch.left.BCPressure.alltime.0.Value	       149.9
pfset Patch.left.BCPressure.alltime.1.Location   	 0.25
pfset Patch.left.BCPressure.alltime.1.Value	       150.0
pfset Patch.left.BCPressure.alltime.2.Location   	 0.5
pfset Patch.left.BCPressure.alltime.2.Value	       150.2
pfset Patch.left.BCPressure.alltime.3.Location   	 0.75
pfset Patch.left.BCPressure.alltime.3.Value	       150.6
pfset Patch.left.BCPressure.alltime.4.Location   	 1.0
pfset Patch.left.BCPressure.alltime.4.Value	       151.0
...
pfrun impes.plinear 
pfundist impes.plinear

# we use pf tools to convert from pressure to head
set press [pfload impes.plinear.out.press.silo]
set head [pfhhead $press]
pfsave $head -silo impes.plinear.head.silo
