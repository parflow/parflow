...
proc pftestFile {file message sig_digits} {
    if [file exists $file] {
	if [file exists ../../correct_output/clm_output/$file] {

	    set correct [pfload ../../correct_output/clm_output/$file]
	    set new     [pfload                $file]
	    ...
	    puts "FAILED : regression check output file <../../correct_output/clm_output/$file> does not exist"
	}
    } {
