...
set p [lindex $argv 0]
set q [lindex $argv 1]
set xcells [lindex $argv 3]
set ycells [lindex $argv 3]
set use_jacobian [lindex $argv 4]
...
pfset ComputationalGrid.NX          [expr $xcells]
pfset ComputationalGrid.NY          [expr $ycells]
...
pfset Solver.Nonlinear.UseJacobian                       $use_jacobian
...
if {$use_jacobian eq "True"} {
        pfwritedb [format "clayL_%d_%d_%d_%d_%d" [lindex $argv 0] [lindex $argv 1] [lindex $argv 2] [lindex $argv 3] 1]
} else {
        pfwritedb [format "clayL_%d_%d_%d_%d_%d" [lindex $argv 0] [lindex $argv 1] [lindex $argv 2] [lindex $argv 3] 0]
}
#pfrun clayL