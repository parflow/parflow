...
washita.GeomInput.indi_input.GeomNames = 's1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 s12 s13 g1 g2 g3 g4 g5 g6 g7 g8'
...
washita.Geom.domain.Saturation.N = 2.
...
washita.Solver.CLM.Vegetation.Parameters.pfset(yaml_file='clm_input/washita_veg_params_ref.yaml')
...
for land_cover_name in ['croplands', 'forest_dn', 'grasslands', 'savannas']:
  ...
  land_frac[land_cover_name].FileName = f'clm_input/washita_clm_{land_cover_name}_landfrac.pfb'
