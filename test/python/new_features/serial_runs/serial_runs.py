...
dover_1.Geom.left.Perm.LambdaX = 50.
dover_1.Geom.left.Perm.LambdaY = 50.
...
dover_1.Geom.right.Perm.LambdaX = 50.
dover_1.Geom.right.Perm.LambdaY = 50.
...
dover_1.Geom.domain.RelPerm.N = 2.
...
dover_1.Geom.domain.Saturation.N = 2.
...
dover_1.Mannings.Geom.left.Value = 5.e-6
dover_1.Mannings.Geom.right.Value = 5.e-6
dover_1.Mannings.Geom.channel.Value = 1.e-6
