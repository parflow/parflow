...
SubsurfacePropertiesBuilder(LW_Test)\
  .load_txt_content(LW_subsurface_properties) \
  .apply()
...
print('Clearing:')
SubsurfacePropertiesBuilder(LW_Test) \
  .load_csv_file('$PF_SRC/test/input/LW_test_data_clear.csv') \
  .apply()
...
SubsurfacePropertiesBuilder(LW_Test) \
  .load_csv_file('$PF_SRC/test/input/LW_test_data.csv') \
  .apply() \
  .print_as_table(props_in_header=False)
print('+'*40)
...
SubsurfacePropertiesBuilder(LW_Test) \
    .load_txt_file('$PF_SRC/test/input/LW_test_data.txt') \
    .apply() \
    .print_as_table()
print('+'*40)
...
SubsurfacePropertiesBuilder(LW_Test) \
    .load_txt_file('$PF_SRC/test/input/LW_test_data_transposed.txt') \
    .apply() \
    .print()
print('+'*40)
