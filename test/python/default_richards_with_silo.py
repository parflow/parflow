...
default_richards.Solver.Linear.Preconditioner = "PFMGOctree"

default_richards.Solver.WriteSiloSubsurfData = True
default_richards.Solver.WriteSiloPressure = True
default_richards.Solver.WriteSiloSaturation = True
default_richards.Solver.WriteSiloConcentration = True

# -----------------------------------------------------------------------------
# Run ParFlow
# -----------------------------------------------------------------------------

new_output_dir_name = get_absolute_path(f"test_output/{test_name}")
...
# Python does not support silo yet

# test_files = ["perm_x", "perm_y", "perm_z"]
# for test_file in test_files:
#     filename = f"/{run_name}.out.{test_file}"
#     if not pf_test_file(
#         new_output_dir_name + filename + ".silo",
#         correct_output_dir_name + filename + ".pfb",
...
#         filename = f"/{run_name}.out.{test_file}.{timestep}"
#         if not pf_test_file(
#             new_output_dir_name + filename + ".silo",
#             correct_output_dir_name + filename + ".pfb",
...
# for test_file in test_files:
#     for i in range(51):
#         filename = f"/{run_name}.out.velx.{timestep}"
