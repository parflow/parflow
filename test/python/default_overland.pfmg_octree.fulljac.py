...
dover = Run("default_overland_pfmg_octree_fulljac", __file__)
...
dover.Solver.Linear.Preconditioner.PCMatrixType = 'FullJacobian'
...
dir_name = get_absolute_path('test_output/dover_pof')
mkdir(dir_name)
