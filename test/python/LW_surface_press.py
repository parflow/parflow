...
LW_surface_press.Geom.domain.RelPerm.Alpha = 1.
LW_surface_press.Geom.domain.RelPerm.Alpha = 1.0
LW_surface_press.Geom.domain.RelPerm.N = 3.
...
LW_surface_press.Geom.domain.Saturation.Alpha = 1.0
LW_surface_press.Geom.domain.Saturation.N = 3.
...
LW_surface_press.Solver.ResetSurfacePressure.ThresholdPressure  = 10. 
