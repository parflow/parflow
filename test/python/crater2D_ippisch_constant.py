# -----------------------------------------------------------------------------
#  crater2D with Ippisch air-entry modification and lookup tables
#  Tests: AirEntryMode = Constant, AirEntryHead = 0.02, n < 2, RelPerm + Saturation tables
# -----------------------------------------------------------------------------
...
dir_name = get_absolute_path("test_output/crater_ippisch_constant")
mkdir(dir_name)
...
crater.Phase.Saturation.VanGenuchten.AirEntryMode = "Constant"
crater.Phase.Saturation.VanGenuchten.AirEntryHead = 0.02
