...
sabino_mask = load_patch_matrix_from_sa_file(get_absolute_path('../simple-mask/Sabino_Mask.sa'))
# sabino_mask = load_patch_matrix_from_asc_file(get_absolute_path('Sabino_Mask.asc'))

sabino_mask_written = write_patch_matrix_as_sa(sabino_mask, get_absolute_path('sabino_mask_written.sa'))

with open(get_absolute_path('../simple-mask/Sabino_Mask.sa'), "rt") as ref:
    with open(get_absolute_path('sabino_mask_written.sa'), "rt") as new:
