...
mask = load_patch_matrix_from_image_file(
  get_absolute_path('mask.png'))

top_patches = load_patch_matrix_from_image_file(
  get_absolute_path('mask_top.png'), color_to_patch, fall_back_id=6)

side_patches = load_patch_matrix_from_image_file(
  get_absolute_path('mask_side.png'), color_to_patch, fall_back_id=3)
