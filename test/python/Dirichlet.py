...
dirichlet.ComputationalGrid.DX = 1.
dirichlet.ComputationalGrid.DY = 1.
...
dirichlet.Geom.domain.RelPerm.Alpha = 1.
dirichlet.Geom.domain.RelPerm.N = 2.
...
dirichlet.Geom.domain.Saturation.Alpha = 1.
dirichlet.Geom.domain.Saturation.N = 2.
dirichlet.Geom.domain.Saturation.SRes = 0.2
dirichlet.Geom.domain.Saturation.SSat = 1.
...
dirichlet.Mannings.Geom.domain.Value = 0.
...
for i in range(0, 2):
    ...
    if not pf_test_file_with_abs(new_output_dir_name + filename, correct_output_dir_name + filename,
                                 f"Max difference in x-velocity for timestep {timestep}", abs_value, sig_digits):
        passed = False
    filename = f"/{run_name}.out.vely.{timestep}.pfb"
    if not pf_test_file_with_abs(new_output_dir_name + filename, correct_output_dir_name + filename,
                                 f"Max difference in y-velocity for timestep {timestep}", abs_value, sig_digits):
        passed = False
    filename = f"/{run_name}.out.vely.{timestep}.pfb"
    if not pf_test_file_with_abs(new_output_dir_name + filename, correct_output_dir_name + filename,
                                 f"Max difference in z-velocity for timestep {timestep}", abs_value, sig_digits):
        passed = False
