# ------------------------------------------------------------------------------------
# Running different configurations of tilted V with two seepage patches in the channel
# ------------------------------------------------------------------------------------
...
overland = Run("overland_tiltedV_KWE_top_patch_3", __file__)
...
overland.Geom.domain.Patches = "bottom side slope channel seepage1 seepage2"
...
overland.Patch.seepage1.BCPressure.Type = "OverlandFlow"
overland.Patch.seepage1.BCPressure.Cycle = "rainrec"
overland.Patch.seepage1.BCPressure.rain.Value = -0.001
overland.Patch.seepage1.BCPressure.rec.Value = 0.0000
overland.Patch.seepage1.BCPressure.Seepage = True

overland.Patch.seepage2.BCPressure.Type = "OverlandFlow"
overland.Patch.seepage2.BCPressure.Cycle = "rainrec"
overland.Patch.seepage2.BCPressure.rain.Value = -0.001
overland.Patch.seepage2.BCPressure.rec.Value = 0.0000
overland.Patch.seepage2.BCPressure.Seepage = True
...
#overland.Solver.OverlandKinematic.SeepagePatches = "5 6"
...
test_dir = get_absolute_path("test_output/overland_tiltedV_KWE_top_patch_3/")
overland.Patch.slope.BCPressure.Type = "OverlandKinematic"
overland.Patch.channel.BCPressure.Type = "OverlandKinematic"
overland.Patch.seepage1.BCPressure.Type = "OverlandKinematic"
overland.Patch.seepage2.BCPressure.Type = "OverlandKinematic"
...
run_name = "TiltedV_OverlandKin_TopPatch3_Ypos"
...
run_name = "TiltedV_OverlandKin_TopPatch3_Yneg"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
...
run_name = "TiltedV_OverlandKin_TopPatch3_Xpos"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
...
run_name = "TiltedV_OverlandKin_TopPatch3_Xneg"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
