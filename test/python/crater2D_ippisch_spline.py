...
#  Tests: AirEntryMode = InverseAlpha, n < 2, RelPerm + Saturation tables
# -----------------------------------------------------------------------------
...
run_name = "crater2D_ippisch_spline"
...
dir_name = get_absolute_path("test_output/crater_ippisch_spline")
mkdir(dir_name)
