# -----------------------------------------------------------------------------
# Running different configurations of tilted V with a seepage patch in the channel
# -----------------------------------------------------------------------------
...
overland = Run("overland_tiltedV_KWE_top_patch", __file__)
...
overland.Geom.domain.Patches = "bottom side slope channel"
...
overland.Patch.channel.BCPressure.Seepage = True
...
overland.Solver.Nonlinear.MaxIter = 400
...
run_name = "TiltedV_OverlandKin_TopPatch_Ypos"
...
run_name = "TiltedV_OverlandKin_TopPatch_Yneg"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
...
run_name = "TiltedV_OverlandKin_TopPatch_Xpos"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
...
run_name = "TiltedV_OverlandKin_TopPatch_Xneg"
overland.set_name(run_name)
print("##########")
print(f"Running {run_name}")
new_output_dir_name = get_absolute_path(os.path.join(test_dir, f"{run_name}"))
