...
parameters = get_absolute_path("../input/deep_aquifer_parameters.nc")

test.Patch.bottom.BCPressure.Type = "DeepAquifer"
test.Patch.bottom.BCPressure.Cycle = "constant"
test.Patch.BCPressure.DeepAquifer.SpecificYield.Type = "NCFile"
test.Patch.BCPressure.DeepAquifer.SpecificYield.FileName = parameters
test.Patch.BCPressure.DeepAquifer.AquiferDepth.Type = "Constant"
test.Patch.BCPressure.DeepAquifer.AquiferDepth.Value = 90.0
test.Patch.BCPressure.DeepAquifer.Permeability.Type = "NCFile"
test.Patch.BCPressure.DeepAquifer.Permeability.FileName = parameters
test.Patch.BCPressure.DeepAquifer.Elevations.Type = "NCFile"
test.Patch.BCPressure.DeepAquifer.Elevations.FileName = parameters
