...
if use_slopes > 0:
  wbx.TopoSlopesX.Geom.left.Value = -0.005
  wbx.TopoSlopesX.Geom.right.Value = 0.005
  wbx.TopoSlopesX.Geom.channel.Value = 0.00
else:
...
wbx.Solver.Nonlinear.UseJacobian = True
