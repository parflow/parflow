...
# The bottom is the DeepAquiferBC and the top OverlandDiffusive.
...
run_name = "deep_aquifer_vcatch_diff"
...
test.Patch.top.BCPressure.Type = "OverlandDiffusive"
...
test.Solver.OverlandDiffusive.Epsilon = 1e-5
