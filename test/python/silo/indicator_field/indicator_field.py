...
indicator_field.ComputationalGrid.DX = (UpperX - LowerX)/NX
indicator_field.ComputationalGrid.DY = (UpperY - LowerY)/NY
indicator_field.ComputationalGrid.DZ = (UpperZ - LowerZ)/NZ
...
indicator_field.TopoSlopesX.GeomNames = ''
...
indicator_field.TopoSlopesY.GeomNames = ''
...
indicator_field.Mannings.GeomNames = ''
indicator_field.Mannings.Geom.domain.Value = 0.0
...
generatedFile, runId = indicator_field.write()
