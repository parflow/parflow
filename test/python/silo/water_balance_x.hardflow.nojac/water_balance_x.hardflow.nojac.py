...
if use_slopes > 0:
  ...
  water_balance_x.TopoSlopesX.Geom.channel.Value = 0.001*use_slopes
else:
  water_balance_x.TopoSlopesX.Geom.left.Value = 0.000
  water_balance_x.TopoSlopesX.Geom.right.Value = 0.000
...
if use_slopes > 0:
  water_balance_x.TopoSlopesY.Geom.left.Value = -0.005
  water_balance_x.TopoSlopesY.Geom.right.Value = 0.005
...
water_balance_x.Solver.Nonlinear.UseJacobian = False
