...
drich.Solver.Nonlinear.VariableDz =  True

drich.dzScale.GeomNames            = "domain"
drich.dzScale.Type                 = "nzList"

drich.dzScale.nzListNumber     =     10

drich.Cell._0.dzScale.Value    =     1
drich.Cell._1.dzScale.Value      =   1.0/2.0
drich.Cell._2.dzScale.Value       =  1.0/4.0
drich.Cell._3.dzScale.Value        = 1.0/8.0
drich.Cell._4.dzScale.Value       =  1.0/16.0
drich.Cell._5.dzScale.Value        = 1.0/32.0
drich.Cell._6.dzScale.Value        = 1.0/64.0
drich.Cell._7.dzScale.Value        = 1.0/128.0
drich.Cell._8.dzScale.Value         =1.0/256.0
drich.Cell._9.dzScale.Value         =1.0/512.0
