...
wc_test.Patch.x_upper.BCPressure.alltime.Value = -1.0  # ocean boundary is 1m below land surface
...
wc_test.TopoSlopesX.Geom.domain.Value = -0.1  #slope in X-direction to allow ponded water to run off
...
wc_test.Mannings.Geom.domain.Value  = 2.e-6
