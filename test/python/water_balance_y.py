...
wby.Geom.left.Perm.LambdaX = 50.0
wby.Geom.left.Perm.LambdaY = 50.0
...
wby.Geom.right.Perm.LambdaX = 50.0
wby.Geom.right.Perm.LambdaY = 50.0
...
wby.Geom.domain.Saturation.N = 2.0
...
wby.Mannings.Geom.left.Value = 5.0e-6
wby.Mannings.Geom.right.Value = 5.0e-6
wby.Mannings.Geom.channel.Value = 1.0e-6
...
bc_dict = {
    0: wby.Patch.z_upper.BCPressure.r0.Value,
