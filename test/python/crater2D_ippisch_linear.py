# -----------------------------------------------------------------------------
#  crater2D with Ippisch air-entry modification and Linear-interpolation tables
#  Tests: AirEntryMode = InverseAlpha, n < 2,
#         RelPerm + Saturation tables with InterpolationMethod = Linear
# -----------------------------------------------------------------------------
...
run_name = "crater2D_ippisch_linear"
...
dir_name = get_absolute_path("test_output/crater_ippisch_linear")
mkdir(dir_name)

cp("$PF_SRC/test/input/crater2D.pfsol", dir_name)

# ---------------------------------------------------------
# VG parameters: n < 2 to exercise the Ippisch modification
# ---------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Relative Permeability (with lookup tables)
# -----------------------------------------------------------------------------
...
crater.Geom.zone1.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone2.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone3above4.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone3left4.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone3right4.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone3below4.RelPerm.InterpolationMethod = "Linear"
...
crater.Geom.zone4.RelPerm.InterpolationMethod = "Linear"

# ---------------------------------------------------------
# Saturation (with lookup tables)
# ---------------------------------------------------------
...
crater.Geom.zone1.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone2.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone3above4.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone3left4.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone3right4.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone3below4.Saturation.InterpolationMethod = "Linear"
...
crater.Geom.zone4.Saturation.InterpolationMethod = "Linear"
