...
def run_check_output(runner, run_name):
    ...
    runner.run(working_directory=new_output_dir_name)
...
def create_runner(run_name, etachoice):
    ...
    crater.TimingInfo.StopTime = 300.0
    crater.TimingInfo.DumpInterval = 30.0
    ...
    crater.Geom.zone1.RelPerm.Alpha = 3.34
    crater.Geom.zone1.RelPerm.N = 1.982

    crater.Geom.zone2.RelPerm.Alpha = 3.63
    crater.Geom.zone2.RelPerm.N = 1.632

    crater.Geom.zone3above4.RelPerm.Alpha = 3.45
    crater.Geom.zone3above4.RelPerm.N = 1.573

    crater.Geom.zone3left4.RelPerm.Alpha = 3.45
    crater.Geom.zone3left4.RelPerm.N = 1.573

    crater.Geom.zone3right4.RelPerm.Alpha = 3.45
    crater.Geom.zone3right4.RelPerm.N = 1.573

    crater.Geom.zone3below4.RelPerm.Alpha = 3.45
    crater.Geom.zone3below4.RelPerm.N = 1.573

    crater.Geom.zone4.RelPerm.Alpha = 3.45
    crater.Geom.zone4.RelPerm.N = 1.573
    ...
    crater.Geom.zone1.Saturation.Alpha = 3.34
    crater.Geom.zone1.Saturation.N = 1.982
    crater.Geom.zone1.Saturation.SRes = 0.2771
    crater.Geom.zone1.Saturation.SSat = 1.0

    crater.Geom.zone2.Saturation.Alpha = 3.63
    crater.Geom.zone2.Saturation.N = 1.632
    crater.Geom.zone2.Saturation.SRes = 0.2806
    crater.Geom.zone2.Saturation.SSat = 1.0

    crater.Geom.zone3above4.Saturation.Alpha = 3.45
    crater.Geom.zone3above4.Saturation.N = 1.573
    crater.Geom.zone3above4.Saturation.SRes = 0.2643
    crater.Geom.zone3above4.Saturation.SSat = 1.0

    crater.Geom.zone3left4.Saturation.Alpha = 3.45
    crater.Geom.zone3left4.Saturation.N = 1.573
    crater.Geom.zone3left4.Saturation.SRes = 0.2643
    crater.Geom.zone3left4.Saturation.SSat = 1.0

    crater.Geom.zone3right4.Saturation.Alpha = 3.45
    crater.Geom.zone3right4.Saturation.N = 1.573
    crater.Geom.zone3right4.Saturation.SRes = 0.2643
    crater.Geom.zone3right4.Saturation.SSat = 1.0

    crater.Geom.zone3below4.Saturation.Alpha = 3.45
    crater.Geom.zone3below4.Saturation.N = 1.573
    ...
    crater.Geom.zone4.Saturation.Alpha = 0.345
    crater.Geom.zone4.Saturation.N = 1.573
    ...
    crater.Solver.Linear.MaxRestarts = 2
    ...
    match etachoice:
        case "EtaConstant":
            crater.Solver.Nonlinear.EtaChoice = "EtaConstant"
            crater.Solver.Nonlinear.EtaValue = 1e-5
        case "Walker1":
            crater.Solver.Nonlinear.EtaChoice = "Walker1"
        case "Walker2":
