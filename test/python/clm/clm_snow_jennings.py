# -----------------------------------------------------------------------------
# CLM Snow Jennings Test
#
# This test verifies that the Jennings (2018) rain-snow partitioning method works.
# It uses bivariate logistic regression with temperature and relative humidity:
# psnow = 1 / (1 + exp(a + b*T + g*RH))
#
# The Jennings method accounts for both temperature and humidity effects on
# precipitation phase, which is important for accurate snow accumulation
# prediction across diverse climates.
#
# Reference: Jennings et al. (2018) Nature Communications, doi:10.1038/s41467-018-03629-7
#
# New keys tested:
#   Solver.CLM.SnowPartition = "Jennings"
#   Solver.CLM.JenningsCoeffA = -10.04
#   Solver.CLM.JenningsCoeffB = 1.41
#   Solver.CLM.JenningsCoeffG = 0.09
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Snow Partitioning - Use Jennings (2018) bivariate logistic method
# psnow = 1 / (1 + exp(a + b*T + g*RH))
# T in Celsius, RH in percent
# These are the default coefficients from Jennings et al. (2018)
# -----------------------------------------------------------------------------

clm.Solver.CLM.SnowPartition = "Jennings"
clm.Solver.CLM.JenningsCoeffA = -10.04
clm.Solver.CLM.JenningsCoeffB = 1.41
clm.Solver.CLM.JenningsCoeffG = 0.09
