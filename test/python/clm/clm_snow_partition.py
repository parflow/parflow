# -----------------------------------------------------------------------------
# CLM Snow Partition Test
#
# This test verifies that the rain-snow partitioning options work correctly.
# It runs with WetbulbThreshold partitioning and compares to reference output.
#
# The wet-bulb partitioning method accounts for evaporative cooling of
# falling hydrometeors, which is important in dry mountain climates where
# snow can persist at air temperatures above 0°C.
#
...
# -----------------------------------------------------------------------------
# Snow Partitioning - Use WetbulbThreshold method
# This exercises the wet-bulb temperature partitioning code path
# -----------------------------------------------------------------------------

clm.Solver.CLM.SnowPartition = "WetbulbThreshold"
clm.Solver.CLM.WetbulbThreshold = 274.15  # 1 degree C
