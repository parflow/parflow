# -----------------------------------------------------------------------------
# CLM Snow SZA Fractional Snow Cover Test
#
# This test verifies that the solar zenith angle (SZA) modulated fractional
# snow cover scheme works correctly. When FracSnoScheme = "SZA", CLM uses
# a cosine-of-solar-zenith-angle weighted running average to compute
# fractional snow cover, accounting for the fact that low-sun conditions
# reduce effective snow visibility from above.
#
# New keys tested:
#   Solver.CLM.FracSnoScheme = "SZA"
#   Solver.CLM.FracSnoRoughnessMin = 1.0e-6    # Non-default (default=1e-8)
#   Solver.CLM.FracSnoRoughnessMax = 0.15      # Non-default (default=0.2)
#   Solver.CLM.FracSnoGammaSZA = 4.0           # Default value
#   Solver.CLM.FracSnoAvgWindow = 72.0         # Default value
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# SZA-Modulated Fractional Snow Cover
# When FracSnoScheme = "SZA", CLM uses a cosine-of-solar-zenith-angle
# weighted running average for fractional snow cover. This accounts for
# how low-sun conditions affect effective snow visibility.
# FracSnoRoughness is set to 0.02 (non-default) to exercise the parameter.
# -----------------------------------------------------------------------------

clm.Solver.CLM.FracSnoScheme = "SZA"
clm.Solver.CLM.FracSnoRoughnessMin = 1.0e-6  # Non-default (default=1e-8)
clm.Solver.CLM.FracSnoRoughnessMax = 0.15  # Non-default (default=0.2)
clm.Solver.CLM.FracSnoGammaSZA = 4.0  # Default value
clm.Solver.CLM.FracSnoAvgWindow = 72.0  # Default value
...
correct_output_dir_name = get_absolute_path("$PF_SRC/test/correct_output/" + run_name)
