# -----------------------------------------------------------------------------
# CLM Snow Albedo Test
#
# This test verifies that the snow albedo scheme options work correctly.
# It runs with the Tarboton albedo scheme and compares to reference output.
#
# The Tarboton scheme uses Arrhenius temperature-dependent aging where
# decay accelerates near the melting point.
#
# Reference: Tarboton & Luce (1996) WRR, doi:10.1029/96WR01049
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Snow Albedo Scheme - Use Tarboton temperature-dependent aging
# This exercises the Tarboton albedo code path
# -----------------------------------------------------------------------------

clm.Solver.CLM.AlbedoScheme = "Tarboton"
