# -----------------------------------------------------------------------------
# CLM Compensatory Root Water Uptake Test (RZWaterStress=2)
#
# This test verifies compensatory root water uptake where wet soil layers
# compensate for dry layers via a PFT-dependent omega_max factor.
# Based on Li et al. (2001) J. Hydrology 252:189-204.
#
# Uses drv_vegp_pft.dat which includes omega_max values per PFT.
# Sets RZWaterStress=2 with VegWaterStress=Saturation.
# btran = min(1.0, omega_max * SUM(rootfr * soil_resistance))
# Distribution uses the same weighted scheme as RZWaterStress=1.
#
# @RMM March 2026
# -----------------------------------------------------------------------------
...
# Use PFT vegp with omega_max values
cp("$PF_SRC/test/python/clm/clm_input/drv_vegp_pft.dat", dir_name + "/drv_vegp.dat")
...
# -----------------------------------------------------------------------------
# ET / Water Stress Keys — Compensatory RWU
# PFT photosynthesis and omega_max come from drv_vegp_pft.dat
# -----------------------------------------------------------------------------
...
# Set wilting point limit and field capacity
clm.Solver.CLM.WiltingPoint = 0.2
clm.Solver.CLM.FieldCapacity = 1.00
# Compensatory RWU: wet layers compensate for dry (Li et al 2001)
# omega_max per PFT is read from drv_vegp_pft.dat
clm.Solver.CLM.RZWaterStress = 2
# No irrigation
