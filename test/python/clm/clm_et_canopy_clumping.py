# -----------------------------------------------------------------------------
# CLM ET Canopy Clumping Test
#
# This test verifies vegetation clumping index support in the two-stream
# radiation scheme. Clumping (omega < 1) accounts for non-random leaf
# distribution, allowing more radiation to penetrate through canopy gaps.
#
# Uses drv_vegp_pft.dat which includes PFT-dependent clump values
# (0.58-0.95, from He et al. 2012). Only affects radiation calculations
# (two-stream and fsun); interception/capacity use real LAI.
# Reference: He et al. (2012) Global Biogeochem. Cycles.
# -----------------------------------------------------------------------------
...
run_name = "clm_et_canopy_clumping"
...
# -----------------------------------------------------------------------------
# No special PF keys — clumping is activated via drv_vegp_pft.dat
# which contains PFT-dependent clump values (He et al. 2012)
# -----------------------------------------------------------------------------
