# -----------------------------------------------------------------------------
# CLM Best Practices Test
#
# Tests the recommended best-practice CLM driver file configuration:
#   - drv_clmin_bestpractice.dat: 30m forcing heights, dewmx=0.2, dead params removed
#   - drv_vegp_bestpractice.dat: CLM4.5 optical corrections + PFT photosynthesis
#   - drv_vegm.dat: unchanged
#
# This test produces DIFFERENT output from the baseline because:
#   - 30m forcing heights change aerodynamic resistance
#   - dewmx=0.2 changes canopy interception
#   - CLM4.5 optical params change radiation partitioning
#   - PFT photosynthesis changes stomatal conductance
#
# Reference output: correct_output/clm_best_practices/
# (generated on first successful run)
# -----------------------------------------------------------------------------
...
# Use BEST PRACTICE driver files
