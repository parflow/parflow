...
clm_vtk.ComputationalGrid.DX = 1000.
clm_vtk.ComputationalGrid.DY = 1000.
...
clm_vtk.Geom.domain.Upper.X = 5000.
clm_vtk.Geom.domain.Upper.Y = 5000.
clm_vtk.Geom.domain.Upper.Z = 5.
...
clm_vtk.Geom.domain.Perm.LambdaX = 3000.
clm_vtk.Geom.domain.Perm.LambdaY = 2000.
clm_vtk.Geom.domain.Perm.LambdaZ = 5.
