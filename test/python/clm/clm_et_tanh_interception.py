# -----------------------------------------------------------------------------
# CLM ET Tanh Interception Test
#
# This test verifies CLM5-style tanh canopy interception (InterceptionScheme).
#
# Uses drv_vegp_pft.dat with PFT photosynthesis params.
# Sets InterceptionScheme=CLM5Tanh with InterceptionTanhAlpha=1.0 (CLM5 default).
# Formula: fpi = alpha * tanh(LAI+SAI), which approaches 1.0 for LAI>2,
# correcting the CLM3 exponential ceiling of 0.25.
...
run_name = "clm_et_tanh_interception"
...
# -----------------------------------------------------------------------------
# ET Keys - CLM5 tanh interception scheme
# -----------------------------------------------------------------------------

clm.Solver.CLM.InterceptionScheme = "CLM5Tanh"
clm.Solver.CLM.InterceptionTanhAlpha = 1.0
