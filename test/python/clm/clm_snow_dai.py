...
# CLM Snow Dai Test
#
# This test verifies that the Dai (2008) rain-snow partitioning method works.
# Formula: F(%) = a * [tanh(b*(T-c)) - d]
#
# The Dai method uses a hyperbolic tangent function fitted to 30 years of
# global weather station observations of precipitation phase.
#
# Reference: Dai (2008) GRL, doi:10.1029/2008GL033295
#
# New keys tested (defaults from Table 1a, Land, ANN):
#   Solver.CLM.SnowPartition = "Dai"
#   Solver.CLM.DaiCoeffA = -48.2292  (scaling factor)
#   Solver.CLM.DaiCoeffB = 0.7205    (slope)
#   Solver.CLM.DaiCoeffC = 1.1662    (half-frequency T in C)
#   Solver.CLM.DaiCoeffD = 1.0223    (asymmetry)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Snow Partitioning - Use Dai (2008) sigmoidal method
# F(%) = a * [tanh(b*(T-c)) - d], converted to fraction internally
# Coefficients from Dai (2008) Table 1a (Land, ANN):
#   a = -48.2292 (scaling factor, negative)
#   b = 0.7205   (slope at half-frequency temperature)
#   c = 1.1662   (half-frequency temperature in C, ~50% snow)
#   d = 1.0223   (asymmetry parameter)
# Reference: Dai (2008) GRL doi:10.1029/2008GL033295
# -----------------------------------------------------------------------------

clm.Solver.CLM.SnowPartition = "Dai"
clm.Solver.CLM.DaiCoeffA = -48.2292
clm.Solver.CLM.DaiCoeffB = 0.7205
clm.Solver.CLM.DaiCoeffC = 1.1662
clm.Solver.CLM.DaiCoeffD = 1.0223
