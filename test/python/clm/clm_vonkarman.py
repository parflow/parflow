# -----------------------------------------------------------------------------
# CLM von Karman constant test (Solver.CLM.VonKarman = 0.4)
#
# Exercises the Solver.CLM.VonKarman key, which sets the von Karman constant
# used in the CLM surface-layer similarity calculations. The PF-CLM default is
# 0.378 (the BATS1e value prescribed in PILPS Phase 2, Chen et al. 1997); the
# standard CLM value is 0.4. This test runs the standard CLM case with 0.4.
# All other CLM tests exercise the default and must remain bit-for-bit.
#
# @RMM September 2026
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# ET / Water Stress Keys (standard CLM test settings) plus the von Karman key
# -----------------------------------------------------------------------------
...
# von Karman constant: standard CLM value (PF-CLM default is 0.378)
clm.Solver.CLM.VonKarman = 0.4
# No irrigation
