# -----------------------------------------------------------------------------
# CLM ET Medlyn Stomatal Conductance Test
#
# This test verifies the Medlyn (2011) stomatal conductance scheme.
#
# Uses drv_vegp_pft.dat with PFT photosynthesis params + g1_medlyn values.
# Sets StomataScheme="Medlyn" to activate VPD-based stomatal conductance.
# Reference: Medlyn et al. (2011) Global Change Biology.
# g1 values from Lin et al. (2015) Nature Climate Change.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# ET Keys - Medlyn stomatal conductance
# -----------------------------------------------------------------------------

clm.Solver.CLM.StomataScheme = "Medlyn"
