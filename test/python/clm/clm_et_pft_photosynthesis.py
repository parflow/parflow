# -----------------------------------------------------------------------------
# CLM ET PFT Photosynthesis Test
#
# This test verifies PFT-dependent photosynthesis parameters and the
# improved stomata physics (Rd, smooth colimitation, niter=5) that
# activate automatically when drv_vegp.dat contains PFT params.
#
# Uses drv_vegp_pft.dat which includes vcmx25, c3psn, mp, bp, qe25,
# folnmx blocks. The photosyn_custom flag triggers automatically.
# All PF keys at defaults (InterceptionFpiMax=0.25, FwetExponent=0.6667,
# StomataScheme=BallBerry).
# -----------------------------------------------------------------------------
...
run_name = "clm_et_pft_photosynthesis"
...
# Use PFT-dependent vegp file instead of standard one
...
# -----------------------------------------------------------------------------
# ET Keys - ALL AT DEFAULTS
# PFT photosynthesis params come from drv_vegp_pft.dat
# photosyn_custom flag activates automatically
# -----------------------------------------------------------------------------

# (All at defaults: InterceptionFpiMax=0.25, FwetExponent=0.6667,
#  StomataScheme=BallBerry)
