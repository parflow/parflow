# -----------------------------------------------------------------------------
# CLM ET Interception Test
#
# This test verifies configurable canopy interception (InterceptionFpiMax)
# and wet canopy fraction exponent (FwetExponent).
#
# Uses drv_vegp_pft.dat with PFT photosynthesis params.
# Sets InterceptionFpiMax=0.5 (doubled from CLM3 default of 0.25)
# and FwetExponent=0.5 (lower than CLM3 default of 0.6667).
# These changes increase canopy interception and slow canopy drying.
# -----------------------------------------------------------------------------
