# -----------------------------------------------------------------------------
# CLM Snow SZA Damping Test
#
# This test verifies that the solar zenith angle (SZA) based snow melt damping
# works correctly. At high solar zenith angles (low sun), CLM underestimates
# snow albedo, causing excessive melt. This damping compensates by reducing
# melt energy at high SZA.
#
# The damping varies linearly from 1.0 (no damping) at coszen >= reference
# to the damping factor at coszen <= minimum.
#
# Reference: Dang et al. (2019) The Cryosphere, doi:10.5194/tc-13-2325-2019
#
# New keys tested:
#   Solver.CLM.SZASnowDamping = 0.8       # 20% energy reduction at high SZA
#   Solver.CLM.SZADampingCoszenRef = 0.5  # Reference coszen (60 deg)
#   Solver.CLM.SZADampingCoszenMin = 0.1  # Min coszen (84 deg)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# SZA-Based Snow Melt Damping
# At high solar zenith angles (low sun), CLM underestimates snow albedo.
# This damping reduces melt energy to compensate.
# coszen_ref = 0.5 corresponds to SZA = 60 degrees (CLM assumption)
# coszen_min = 0.1 corresponds to SZA = 84 degrees
# -----------------------------------------------------------------------------

clm.Solver.CLM.SZASnowDamping = 0.8  # 20% reduction at high SZA
clm.Solver.CLM.SZADampingCoszenRef = 0.5  # Start damping below SZA=60 deg
clm.Solver.CLM.SZADampingCoszenMin = 0.1  # Max damping at SZA=84 deg
