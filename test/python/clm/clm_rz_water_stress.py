...
clm_rz_water_stress.ComputationalGrid.DX = 1000.
clm_rz_water_stress.ComputationalGrid.DY = 1000.
...
clm_rz_water_stress.Geom.domain.Upper.X = 5000.
clm_rz_water_stress.Geom.domain.Upper.Y = 5000.
clm_rz_water_stress.Geom.domain.Upper.Z = 5.

clm_rz_water_stress.Geom.domain.Patches = 'x_lower x_upper y_lower y_upper z_lower z_upper'
...
clm_rz_water_stress.Geom.domain.RelPerm.N = 2.
...
clm_rz_water_stress.Geom.domain.Saturation.N = 2.
...
#-----------------------------------------------------------------------------
clm_rz_water_stress.BCPressure.PatchNames = 'x_lower x_upper y_lower y_upper z_lower z_upper'
#  
...
for i in range(6):
    ...
    if i > 0:
        ...
        if not pf_test_file(dir_name + filename, correct_output_dir_name + filename, f"Max difference in CLM for timestep {timestep}"):
            passed = False
