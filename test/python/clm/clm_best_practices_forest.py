# -----------------------------------------------------------------------------
# CLM Best Practices Forest Test
#
# Tests the recommended best-practice CLM driver file configuration with
# evergreen needleleaf forest (IGBP class 1, ENF):
#   - drv_clmin_bestpractice.dat: 30m forcing heights, dewmx=0.2
#   - drv_vegp_bestpractice.dat: CLM4.5 optical corrections + PFT photosynthesis
#     + canopy clumping (clump=0.62 for ENF)
#   - drv_vegm_forest.dat: 100% ENF coverage
#
# This test validates the full best-practice configuration including canopy
# clumping, which has a larger effect on forests (clump=0.62, LAI=6) than
# on grasslands (clump=0.95, LAI=2) tested by clm_best_practices.py.
#
# Reference output: correct_output/clm_best_practices_forest/
# -----------------------------------------------------------------------------
...
run_name = "clm_best_practices_forest"
...
# Use BEST PRACTICE driver files with FOREST vegetation map
cp("$PF_SRC/test/tcl/clm/drv_clmin_bestpractice.dat", dir_name + "/drv_clmin.dat")
cp("$PF_SRC/test/tcl/clm/drv_vegm_forest.dat", dir_name + "/drv_vegm.dat")
cp("$PF_SRC/test/tcl/clm/drv_vegp_bestpractice.dat", dir_name + "/drv_vegp.dat")
