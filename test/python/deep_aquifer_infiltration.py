...
#-----------------------------------------------------------------------------
new_output_dir_name = get_absolute_path("test_output/deep_aquifer_infiltration")
correct_output_dir_name = get_absolute_path("../correct_output/deep_aquifer_infiltration")
