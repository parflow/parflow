...
# Results should differ from the standard kinematic (the correction adds
# diffusive smoothing), but Picard and FullNewton must converge to the
# same answer.
# -----------------------------------------------------------------------------
...
overland = Run("overland_tiltedV_diffcorr", __file__)
