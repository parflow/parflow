...
#
#  Variant of crater2D_vangtable_linear.py that exercises lookup tables for
#  BOTH RelPerm and Saturation (the original test only tabulates RelPerm
#  and computes Saturation directly via VG analytic). Uses
#  InterpolationMethod = "Linear" on both tables to specifically cover the
#  saturation linear-lookup path added on the ippisch branch.
# -----------------------------------------------------------------------------
...
run_name = "crater2D_vangtable_linear_sat"
...
dir_name = get_absolute_path("test_output/crater_vl_sat")
mkdir(dir_name)
...
# for most "real" parameters for the Van Genuchten curves.
...
crater.Geom.zone1.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone2.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3above4.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3left4.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3right4.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3below4.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone4.RelPerm.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone1.Saturation.NumSamplePoints = VG_points
crater.Geom.zone1.Saturation.MinPressureHead = -300
crater.Geom.zone1.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone2.Saturation.NumSamplePoints = VG_points
crater.Geom.zone2.Saturation.MinPressureHead = -300
crater.Geom.zone2.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3above4.Saturation.NumSamplePoints = VG_points
crater.Geom.zone3above4.Saturation.MinPressureHead = -300
crater.Geom.zone3above4.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3left4.Saturation.NumSamplePoints = VG_points
crater.Geom.zone3left4.Saturation.MinPressureHead = -300
crater.Geom.zone3left4.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3right4.Saturation.NumSamplePoints = VG_points
crater.Geom.zone3right4.Saturation.MinPressureHead = -300
crater.Geom.zone3right4.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone3below4.Saturation.NumSamplePoints = VG_points
crater.Geom.zone3below4.Saturation.MinPressureHead = -300
crater.Geom.zone3below4.Saturation.InterpolationMethod = VG_interpolation_method
...
crater.Geom.zone4.Saturation.NumSamplePoints = VG_points
crater.Geom.zone4.Saturation.MinPressureHead = -300
crater.Geom.zone4.Saturation.InterpolationMethod = VG_interpolation_method
