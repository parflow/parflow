...
if(EXISTS ${ESMFMKFILE})
    ...
    set(ESMF_VERSION
        "${ESMF_VERSION_MAJOR}.${ESMF_VERSION_MINOR}.${ESMF_VERSION_PATCH}"
    )

    # Find the ESMF library
    if(USE_ESMF_STATIC_LIBS)
        find_library(
            ESMF_LIBRARY_LOCATION
            NAMES libesmf.a
            PATHS ${ESMF_LIBSDIR}
            NO_DEFAULT_PATH
        )
        if(ESMF_LIBRARY_LOCATION MATCHES "ESMF_LIBRARY_LOCATION-NOTFOUND")
            message(
                WARNING
                "Static ESMF library (libesmf.a) not found in \
    ...
    string(
        STRIP
            "${ESMF_F90LINKRPATHS} ${ESMF_F90ESMFLINKRPATHS} ${ESMF_F90ESMFLINKPATHS} ${ESMF_F90LINKPATHS} ${ESMF_F90LINKLIBS} ${ESMF_F90LINKOPTS}"
    ...
    message(
        WARNING
        "ESMFMKFILE ${ESMFMKFILE} not found. Try setting ESMFMKFILE \
                   to esmf.mk location."
    )
endif()
