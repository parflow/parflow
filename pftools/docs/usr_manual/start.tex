...
range of systems may be found at the \parflow{} blog: \file{http://parflow.blogspot.com}
...
To compile with \code{CLM} add \code{-PARFLOW_HAVE_CLM=ON} to the configure
line such as:
...
\begin{itemize}
\item to include the \code{CLM} module:  \code{--PARFLOW_HAVE_CLM=ON}
...
will be removed in a future relase.  Please use \code{cmake} and
report bugs.
