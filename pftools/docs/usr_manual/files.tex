...
\pfkey{string}{Solver.Jacobian.Type}{Approximate}
{This key specifies the Jacobian to use for both the linear preconditioner and the nonlinear solver.  Choices for this key 
...
\begin{display}\begin{verbatim}
pfset Solver.Jacobian   Analytic 
\end{verbatim}\end{display}
