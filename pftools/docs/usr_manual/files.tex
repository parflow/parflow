...
\pfkey{integer}{Solver.CLM.SoilLevels}{10}
{This key sets the number of soil levels for CLM.} 
\begin{display}\begin{verbatim}
pfset Solver.CLM.SoilLevels      4
\end{verbatim}\end{display}

\pfkey{integer}{Solver.CLM.LakeLevels}{10}
{This key sets the number of lake levels for CLM.} 
\begin{display}\begin{verbatim}
