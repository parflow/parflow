...
{
This key specifies whether dZ multipliers are to be used, the default is False, which sets them to 1.0.
}
\begin{display}\begin{verbatim}
...
{
This key specifies which method is to be used to assign variable vertical grid spacing.  The only choice currently
available is {\bf Constant} which indicates that a constant is to be
assigned to all grid cells within a geometry.
}
\begin{display}\begin{verbatim}
