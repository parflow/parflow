...
The basic NetCDF functionality of output (pressure and saturation) and initial conditions (pressure) can be tested with following tcl script. CLM output functionality can also be tested with this case.
\begin{display}\begin{verbatim}
parflow/test/washita/tcl_scripts/LW_NetCDF_Test.tcl
\end{verbatim}\end{display}
This test case will be initialized with following initial condition file and slopes.
\begin{display}\begin{verbatim}
