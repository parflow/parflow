...
!@== Variables added for diagnostics
  totsurf  = drv_gridave (n,mask,tile%fgrd,clm%tot_surf*clm%dtime, drv)       ! [43] Total water applied at the ground suface [mm]
  ...
  fraction = drv_gridave (n,mask,tile%fgrd,clm%frac, drv)                     ! [48] TOPMODEL frac [-]
  ...
  write(2008,'(i5,1x,12(e10.2,1x))') clm(1)%istep,totsurf,topsoil,surface,evapor,infiltr,fraction,clm_error,evap_tot, &
