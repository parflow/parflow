...
int KinsolNonlinSolver P((Vector *pressure , Vector *density , Vector *old_density , Vector *saturation , Vector *old_saturation , double t , double dt , ProblemData *problem_data, Vector *old_pressure ));
...
void NlFunctionEval P((Vector *pressure , Vector *fval , ProblemData *problem_data , Vector *saturation , Vector *old_saturation , Vector *density , Vector *old_density , double dt , double time, Vector *old_pressure ));
...
ProblemData *NewProblemData P((Grid *grid ));
...
PFModule *GeometriesInitInstanceXtra P((Grid *grid , double *temp_data ));
...
void ICPhasePressure P((Vector *ic_pressure , ProblemData *problem_data , Problem *problem ));
...
PFModule *PhaseSourceInitInstanceXtra P((void ));
void PhaseSourceFreeInstanceXtra P((void ));
PFModule *PhaseSourceNewPublicXtra P((int num_phases ));
...
PFModule *SetProblemDataInitInstanceXtra P((Problem *problem , Grid *grid , double *temp_data ));
