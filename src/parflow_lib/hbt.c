...
/*===========================================================================*/
HBT *HBT_new(compare_method, free_method, printf_method, scanf_method, malloc_flag)
int (*compare_method)();
void (*free_method)();
void (*printf_method)();
int  (*scanf_method)();
...
{
    HBT *new_tree;
    if( (new_tree = calloc(1, sizeof(HBT))) == NULL)
	return NULL;
...
/*===========================================================================*/
HBT_element *_new_HBT_element(tree, object, sizeof_obj)
HBT *tree;
void *object;
int sizeof_obj;
{
    ...
    if( (n = calloc(1, sizeof(HBT_element))) == NULL)
	return NULL;
...
/* Frees a HBT element.                                                  */
/*===========================================================================*/
void _free_HBT_element(tree, el)
HBT *tree;
HBT_element *el;
{
...
void *obj;
{
	...
	if( (test = 
	    ...
	    return OBJ(temp);   /* return the object that matches the template 
...
/*===========================================================================*/
void *HBT_replace(tree, obj, sizeof_obj)
HBT *tree;
void *obj;
int sizeof_obj;
{
	...
	else if ( test > 0)
	{
	    ...
	    found = TRUE;  /* Found the object that is to be replaced */
...
/*===========================================================================*/
int HBT_insert(tree, obj, sizeof_obj)
HBT *tree;
void *obj;
int sizeof_obj;
{
...
/*===========================================================================*/
void _HBT_printf(file, printf_method, tree)
FILE *file;
void (*printf_method)();
HBT_element *tree;
{
