...
subroutine drv_readvegtf (drv,grid,tile,clm)
...
!=== Read in Vegetation Data
  ...
  open(2,file=drv%vegtf,form='formatted')
...
!=== Make Tile Space
  ...
  write(*,*) 'Actual Number of Tiles:',drv%nch
  write(*,*)
