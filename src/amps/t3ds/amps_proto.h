...
/* amps_allreduce.c */
int amps_ReduceOperation P((amps_Comm comm , amps_Invoice invoice , char *buf_src , int operation ));
...
/* amps_init.c */
void *amps_talloc P((int size ));
void *amps_calloc P((int count , int size ));
...
/* amps_pack.c */
int amps_pack P((amps_Comm comm , amps_Invoice inv ));
...
/* amps_unpack.c */
int amps_unpack P((amps_Comm comm , amps_Invoice inv ));

/* amps_vector.c */
void amps_vector_out P((amps_Comm comm , int type , char **data , int dim , int *len , int *stride ));
void amps_vector_in P((amps_Comm comm , int type , char **data , int dim , int *len , int *stride ));
int amps_vector_sizeof_local P((amps_Comm comm , int type , char **data , int dim , int *len , int *stride ));
