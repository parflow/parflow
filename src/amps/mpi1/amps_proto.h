...
/* amps_allreduce.c */
int amps_AllReduce P((amps_Comm comm , amps_Invoice invoice , MPI_Op operation ));
...
/* amps_pack.c */
int amps_create_mpi_cont_send_type P((amps_Comm comm , amps_Invoice inv ));
...
/* amps_send.c */
int amps_xsend P((amps_Comm comm , int dest , amps_Invoice invoice , char *buffer ));
...
/* amps_unpack.c */
int amps_unpack P((amps_Comm comm , amps_Invoice inv , char *buffer , int buf_size ));
