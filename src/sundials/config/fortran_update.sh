...
abs_top_builddir="/home/smithsg/parflow/pfclm_ms/src/sundials/config/../."
prefix="/home/smithsg/parflow/pfclm_ms/src/sundials"
includedir="${prefix}/include"

FLOAT_TYPE="double"

MPI_INC_DIR="/nfs/apps/mpich/1.2.7p1/bin/../include"

EGREP="grep -E"
FGREP="grep -F"

MPI_COMM_F2C="#define SUNDIALS_MPI_COMM_F2C 1"
