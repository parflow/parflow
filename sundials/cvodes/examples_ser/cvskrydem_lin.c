...
#include "cvodes_spgmr.h"        /* prototypes & consts. for CVSPGMR solver */
#include "cvodes_spbcgs.h"       /* prototypes & consts. for CVSPBCG solver */
#include "cvodes_sptfqmr.h"      /* prototypes & consts. for CVSPTFQMR solver */
#include "sundials_smalldense.h" /* use generic DENSE solver in prec. */
