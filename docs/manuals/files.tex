...
below).  The choice {\bf DeepAquifer} turns on groundwater interactions with a deep aquifer as described in \cite{Rahman2018}. The aquifer is set with the Specific Yield and Thickness parameters, detailed below.   NOTE: These last seven types of boundary condition inputs are for
