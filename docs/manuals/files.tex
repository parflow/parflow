...
{\bf GroundwaterFlow}.  The choice {\bf DirEquilRefPatch} specifies that the
...
below).  The choice {\bf GroundwaterFlow} turns on groundwater interactions with a deep aquifer as described in \cite{Rahman2018}. The aquifer is set with the Specific Yield and Thickness parameters, detailed below.   NOTE: These last seven types of boundary condition inputs are for
...
\pfkey{string}
{Patch.{\em patch\_name}.BCPressure.GroundwaterFlow.{\em parameter}.Type}
{no default}
...
This key specifies the type of the GroundwaterFlow parameter: {`Constant'} will set the parameter to a value set in the key {Patch.{\em patch\_name}.BCPressure.GroundwaterFlow.{\em parameter}.Value}, while {`FileName'} will set the parameter to values read from the file provided in the key {Patch.{\em patch\_name}.BCPressure.GroundwaterFlow.{\em parameter}.FileName}.
}
\begin{display}\begin{verbatim}
...
\pfkey{double}
{Patch.{\em patch\_name}.BCPressure.GroundwaterFlow.{\em parameter}.Value}
{no default}
{
...
\pfkey{string}
{Patch.{\em patch\_name}.BCPressure.GroundwaterFlow.{\em parameter}.FileName}
{no default}
{
