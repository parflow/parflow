...
%=====
\pfkey{string}{Solver.SlopeAccountingCLM}{False}
{This key specifies whether the \code{CLM} allows for the inclusion of slopes when determining solar zenith angles.
 Note that \code{CLM} must be compiled and linked at runtime for this option to be active.
}
\begin{display}\begin{verbatim}
