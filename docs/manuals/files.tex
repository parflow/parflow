...
\pfkey{integer}{NetCDF.CompressioniLevel}{1}
{This key sets the deflate compression level (if NetCDF.Compression is enabled), which influence the overall compression quality. zlib supports values between 0 (no compression), 1 (fastest compression,smaller files) - 9 (slowest compression,smallest files). }
\begin{display}\begin{verbatim}
