...
The \code{all_subgrids} component is a intake_subgrid-array of all subgrids
in the grid.
...
\begin{deftypefn}{Function}{void}{FreeSubgrid}({Subgrid *} \var{intake_subgrid})
...
\begin{deftypefn}{Function}{void}{FreeSubgridArray}({SubgridArray *} \var{intake_subgrid\_array})
...
\begin{defmac} ForSubgridI (int \var{i}, {SubgridArray *} \var{intake_subgrid\_array})

%=========================== DESCRIPTION
\DESCRIPTION
Loops over all intake_subgrid indices in \var{intake_subgrid\_array}, setting
\var{i} to each index.
...
\begin{deftypefn}{Function}{double}{SubgridX}({Subgrid *} \var{intake_subgrid})
\end{deftypefn}
\begin{deftypefn}{Function}{double}{SubgridY}({Subgrid *} \var{intake_subgrid})
\end{deftypefn}
\begin{deftypefn}{Function}{double}{SubgridZ}({Subgrid *} \var{intake_subgrid})

%=========================== DESCRIPTION
\DESCRIPTION
Returns the real-space coordinates corresponding to the
\code{ix}, \code{iy}, and \code{iz} components of \var{intake_subgrid}.
...
\begin{deftypefn}{Function}{Subgrid *}{DuplicateSubgrid}({Subgrid *} \var{intake_subgrid})

%=========================== DESCRIPTION
\DESCRIPTION
Returns a duplicate of \var{intake_subgrid}.
...
\begin{deftypefn}{Function}{void}{AppendSubgrid}({Subgrid *} \var{intake_subgrid}, {SubgridArray *} \var{intake_subgrid\_array})

%=========================== DESCRIPTION
\DESCRIPTION
Appends \var{intake_subgrid} to \var{intake_subgrid\_array}.
...
\begin{deftypefn}{Function}{void}{AppendSubgridArray}({SubgridArray *} \var{intake_subgrid\_array\_0}, {SubgridArray *} \var{intake_subgrid\_array\_1})

%=========================== DESCRIPTION
\DESCRIPTION
Appends \var{intake_subgrid\_array\_0} to \var{intake_subgrid\_array\_1}.
...
\begin{deftypefn}{Function}{Subregion *}{ConvertToSubregion}({Subgrid *} \var{intake_subgrid})

%=========================== DESCRIPTION
\DESCRIPTION
Converts \var{intake_subgrid} to a \code{Subregion *} and returns it.
...
\begin{deftypefn}{Function}{Subregion *}{ProjectSubgrid}({Subgrid *} \var{intake_subgrid}, int \var{sx}, int \var{sy}, int \var{sz}, int \var{ix}, int \var{iy}, int \var{iz})

%=========================== DESCRIPTION
\DESCRIPTION
Projects \var{intake_subgrid} onto an {\em index-region}.
...
The base index-space is determined by the \var{intake_subgrid}.
\var{intake_subgrid} is not modified.
...
\begin{deftypefn}{Function}{Subgrid *}{ExtractSubgrid}(int \var{rx}, int \var{ry}, int \var{rz}, {Subgrid *} \var{intake_subgrid})

%=========================== DESCRIPTION
\DESCRIPTION
Returns, if possible, the largest intake_subgrid with resolution
\var{rx}, \var{ry}, \var{rz},
contained in \var{intake_subgrid}
...
\begin{deftypefn}{Function}{SubgridArray *}{UnionSubgridArray}({SubgridArray *} \var{intake_subgrid\_array})

%=========================== DESCRIPTION
\DESCRIPTION
Unions the subgrids in \var{intake_subgrid\_array}.
