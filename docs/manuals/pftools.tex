...
\multicolumn{4}{|c|}{Domain Operations}  \\ \hline
	...
	pfbuilddomain & Build a intake_subgrid array from a ParFlow database &  & X \\ \hline
...
This command builds a intake_subgrid array given a ParFlow database that contains the domain
...
\item{\begin{verbatim}pfcomputedomain top bottom\end{verbatim}} This
 ...
 domain built will have a single intake_subgrid per processor that covers the
