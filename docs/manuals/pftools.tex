...
\item{\begin{verbatim}pfdist filename [options] \end{verbatim}}
...
specified manually when pfdist is called by using the optional argument -nz followed by the number of layers in the file to be distributed.
If the -nz argument is absent the NZ key is used by default for the processor topology.

For example,
\begin{display}
\begin{verbatim}
pfdist slopex.pfb -nz 1
\end{verbatim}
\end{display}
