...
if(MCT_Fortran_LIBRARY AND MPEU_Fortran_LIBRARY AND SCRIP_Fortran_LIBRARY)
    find_path(
        OASIS_Fortran_INCLUDES
        mod_oasis.mod
        HINTS ${OAS3_ROOT}/build/lib/psmile.MPI1 ${OAS3_ROOT}/include
    )
...
find_package_handle_standard_args(
    OASIS
    DEFAULT_MSG
    OASIS_Fortran_LIBRARY
    OASIS_Fortran_INCLUDES
    OpenMP_FOUND
    NetCDF-Fortran_FOUND
)
...
if(OASIS_FOUND AND NOT TARGET OASIS3MCT::OASIS3MCT)
    ...
    target_include_directories(
        OASIS3MCT::OASIS3MCT
        INTERFACE ${OASIS_Fortran_INCLUDES}
    )
    target_link_libraries(
        ...
        INTERFACE
            ${OASIS_Fortran_LIBRARY}
            ${MCT_Fortran_LIBRARY}
            ${MPEU_Fortran_LIBRARY}
            ${SCRIP_Fortran_LIBRARY}
    )
    target_link_libraries(OASIS3MCT::OASIS3MCT INTERFACE OpenMP::OpenMP_Fortran)
    target_link_libraries(
        OASIS3MCT::OASIS3MCT
        INTERFACE ${NETCDF_Fortran_LIBRARY}
    )
endif()
