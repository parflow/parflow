...
if(EXISTS "${HYPRE_CONFIG_H}")
    ...
    # OpenMP
    file(
        STRINGS ${HYPRE_CONFIG_H}
        HYPRE_USING_OPENMP
        REGEX "HYPRE_USING_OPENMP"
    )
...
if(HYPRE_FOUND AND NOT TARGET Hypre::Hypre)
    ...
    if(DEFINED PARFLOW_HAVE_CUDA)
        if(${PARFLOW_HAVE_CUDA} AND ${HYPRE_USING_CUDA})
            ...
            if(CUDAToolkit_FOUND)
                ...
                message(
                    STATUS
                    "Found Hypre with CUDA backend. The ff. CUDA targets will be added to the linker options: ${_hypre_cuda_targets}"
                )
    ...
    if(${HYPRE_USING_OPENMP})
        ...
        if(OpenMP_FOUND)
            ...
            message(
                STATUS
                "Found Hypre with OpenMP backend. OpenMP flags will be added to the linker options."
            )
        endif()
    endif()
endif()
