  ...
  if(${HYPRE_USING_OPENMP})
    ...
    if(OpenMP_FOUND)
      if(${PARFLOW_HAVE_CUDA})
        # -Xcompiler must be passed to nvcc. See https://stackoverflow.com/questions/3211614/compiling-and-linking-cuda-source-files-with-openmp-support
        target_compile_options(Hypre::Hypre INTERFACE $<$<COMPILE_LANGUAGE:CUDA>: -Xcompiler=${OpenMP_C_FLAGS})
      else()
